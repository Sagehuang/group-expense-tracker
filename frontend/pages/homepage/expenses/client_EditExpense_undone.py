...
class EditExpense(ctk.CTkFrame):
    def __init__(self, master, username):
        ...
        # 2rd frame（主要容器）: Item, Amount, Payer, Participants, Note, Edit
...
# EDIT EXPENSE
    def on_edit(self):
        ...
        if success:
            self.result_label.configure(text='Expense edited successfully.')
            # 清空輸入欄
            ...
            self.result_label.configure(text='Failed to edit expense.')
...
if __name__ == '__main__':
    ...
    edit_expense = EditExpense(app, "Group A")
