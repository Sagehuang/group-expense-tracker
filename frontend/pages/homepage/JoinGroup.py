...
from api_client import join_group
...
class JoinGroup(ctk.CTkFrame):
    def __init__(self, master, show_page_callback, controller):
        ...
        self.title_label = ctk.CTkLabel(self.top_bar, text='Join Group', text_color='black', font=self.font_top_bar)
        ...
        self.group_name_label = ctk.CTkLabel(self.container_frame, text='Group ID', font=self.small_font, anchor='w')
